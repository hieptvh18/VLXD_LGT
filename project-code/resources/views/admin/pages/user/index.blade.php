            ...
            <div class="container">
                <div class="row">
                    <div class="col s10 m6 l6">
                        <h5 class="breadcrumbs-title mt-0 mb-0"><span>Danh sách tài khoản</span></h5>
                    ...
                    <div class="col s2 m6 l6">
                        <a class="btn waves-effect waves-light breadcrumbs-btn right" href="{{ route('admin.user.create') }}">
                            ...
                            <div class="row">
                                <form style="display: flex">
                                    <div class="col s12 m6 l3">
                                        <label for="users-list-role">Vai trò</label>
                                        <div class="input-field">
                                            <select class="form-control" id="users-list-role" name="role">
                                                <option value="">Tất cả</option>
                                                <option value="CUSTOMER" {{ request('role') == \App\Helpers\Constant::USER_CUSTOMER_ROLE ? 'selected' : '' }}>Khách hàng</option>
                                                <option value="ADMIN" {{ request('role') == \App\Helpers\Constant::USER_ADMIN_ROLE ? 'selected' : '' }}>Admin</option>
                                                <option value="SUPER_ADMIN"  {{ request('role') == \App\Helpers\Constant::USER_SUPER_ADMIN_ROLE ? 'selected' : '' }}>Super Admin</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col s12 m6 l3">
                                    ...
                                    <div class="col s12 m6 l3">
                                        ...
                                        <div class="input-field">
                                            <input class="form-control" id="users-list-keyword" name="keyword" placeholder="Nhập text..." />
                                        </div>
                                    </div>
                                    <div class="col s12 m6 l3 display-flex align-items-center show-btn">
                                        <button type="submit" class="btn btn-block indigo waves-effect waves-light">Tìm kiếm</button>
                                    </div>
                                </form>
                            </div>
                        </div>
...
{{--                                            <th>Xóa</th>--}}
                                        ...
                                        @foreach($users as $user)
                                            <tr>
                                                <td></td>
                                                <td>{{ $user->id }}</td>
                                                <td><a href="page-users-view.html">{{ $user->name }}</a>
                                                </td>
                                                <td>{{ $user->email }}</td>
                                                <td>{{ $user->phone }}</td>
                                                <td>{{ $user->last_activity ? \Carbon\Carbon::parse($user->last_activity)->format('Y-m-d H:i:s') : '' }}</td>
                                                <td>{{ $user->ip }}</td>
                                                <td>{{ \App\Helpers\Constant::USER_ROLES_NAME[$user->role] }}</td>
                                                <td>
                                                <span class="chip {{ $user->is_active ? 'green' : 'red' }} lighten-5">
                                                    @if($user->is_active)
                                                ...
                                                <td><a href="{{ route('admin.user.edit', ['user' => $user->id]) }}"><i class="material-icons">edit</i></a></td>
{{--                                                <td>--}}
