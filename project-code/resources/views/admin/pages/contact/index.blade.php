...
@section('title', 'Admin - Danh sách khách hàng liên hệ quan tâm Bất động sản')
@section('content')
    <div class="row">
            ...
            <div class="container">
                <div class="row">
                    <div class="col s10 m6 l6">
                        <h5 class="breadcrumbs-title mt-0 mb-0"><span>Danh sách khách hàng liên hệ quan tâm Bất động sản</span></h5>
                ...
                <section class="users-list-wrapper section">
                    <div class="users-list-filter">
                        <div class="card-panel">
                            <div>
                                <form class="display-flex justify-content-start align-items-center">
                                    <div style="width: 40%">
                                        <label for="users-list-status">Tìm kiếm</label>
                                        <div class="input-field">
                                            <input required class="form-control" id="users-list-keyword" value="{{ request('keyword') }}" name="keyword"
                                                   placeholder="Nhập tên, số điện thoại liên hệ..."/>
                                        </div>
                                    </div>
                                    <div class="">
                                    ...
                                    <table id="users-list-datatable" class="responsive-table">
                                        ...
                                        @foreach($contacts as $key => $contact)
                                            <tr>
                                                ...
                                                <td>{{ $contact->phone }}</td>
                                                <td>{{ $contact->ip }}</td>
                                                <td title="{{ $contact->item?->item_name }}">
                                                    <a href="{{ route('admin.item.edit', ['item' => $contact->item?->id ?? 0]) }}">
                                                        {{ formatSubStr($contact->item?->item_name, 100) }}
                                                    </a>
                                                </td>
                                                <td title="{{ $contact->content }}">{{ formatSubStr($contact->content, 200) }}</td>
                                                <td>
                                                    <a href="{{ route('admin.contact.edit', ['contact' => $contact->id]) }}"><i
